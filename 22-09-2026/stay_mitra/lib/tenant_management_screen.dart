...
class _TenantManagementScreenState
  ...
  Future<void> _loadTenants() async {
    ...
    try {
      // ==========================================================
      // IMPORTANT: LOAD TENANTS FOR THE CURRENTLY SELECTED PG ONLY
      // ==========================================================
      //
      // Tenant records are linked to a bed.
      // Bed -> Room -> Floor -> Building(PG)
      //
      // Therefore we first find the tenant IDs whose beds belong
      // to the currently active PG, and then load only those
      // TenantModel records.
      //
      // This keeps Sri Sai tenants inside Sri Sai and Sri Durga
      // tenants inside Sri Durga. No cross-PG tenant data will
      ...
      final tenantIdRows = await db.rawQuery(
        '''
