...
class _AddPaymentScreenState extends State<AddPaymentScreen> {
  ...
  Future<void> _savePayment() async {
    ...
    try {
       ...
       * IMPORTANT:
       *
       * TransactionModel should contain tenantId
       * and roomId so that the payment can be
       * associated with the correct tenant.
       *
       * These fields must also be added to:
       * - transaction_model.dart
       * - transactions table
       * - DatabaseHelper insert/read methods
       */
      ...
      final transaction = TransactionModel(
        ...
        // ------------------------------------------------------
        // These two fields require TransactionModel support.
        // ------------------------------------------------------
      ...
      /*
       * Save through TransactionService so that our
       * UI -> Service -> SQLite architecture is preserved.
       */
