...
class _AddExpenseScreenState extends State<AddExpenseScreen> {
  ...
  void _saveExpense() {
    ...
    // If Other is selected, custom category is mandatory
  ...
  List<ExpenseCategory> _utilityCategories() {
    return [
  ...
  List<ExpenseCategory> _staffCategories() {
    return [
  ...
  List<ExpenseCategory> _marketingCategories() {
    return [
  ...
  List<ExpenseCategory> _legalCategories() {
    return [
  ...
  Widget _categoryField() {
    return DropdownButtonFormField<
      ...
      items: [
        ...
        _categoryHeader('Food & Kitchen'),

        ..._foodKitchenCategories()
            .map(_categoryItem),

        _categoryHeader('Housekeeping'),

        ..._housekeepingCategories()
            .map(_categoryItem),

        _categoryHeader('Staff'),

        ..._staffCategories()
            .map(_categoryItem),

        _categoryHeader('Operations'),

        ..._operationsCategories()
            .map(_categoryItem),

        _categoryHeader('Marketing'),
        ...
        _categoryHeader('Financial'),

        ..._financialCategories()
            .map(_categoryItem),

        _categoryHeader('Other'),
