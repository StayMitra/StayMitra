...
class _AccountsScreenState extends State<AccountsScreen>
  ...
  // ------------------------------------------------------------
  // RELOAD WHEN APP / SCREEN BECOMES ACTIVE
  // ------------------------------------------------------------
  ...
  Future<void> _loadTransactions() async {
    ...
    try {
      ...
      // LOAD TRANSACTIONS FROM FIREBASE
      //
      // TransactionService is Firebase-only.
      // It loads transactions from:
      // owners/{ownerId}/properties/{buildingId}/transactions
      // ----------------------------------------------------------
      ...
      // IMPORTANT:
      //
      // SHOW ONLY TRANSACTIONS BELONGING TO
      // CURRENT ACTIVE PG.
      //
      // This prevents:
      //
  ...
  Widget _transactionsList() {
    ...
    //
    // _loadTransactions() already sorts
