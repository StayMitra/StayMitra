...
class MoreScreen extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              _menuCard(
                ...
                // Firebase authenticated owner ID
                onTap: () async {
                  final user =
  ...
  static void _showProfileDialog(
    BuildContext context,
  ) {
    final User? user =
        FirebaseAuth.instance.currentUser;
            ...
            ElevatedButton(
              onPressed: () async {
                try {
                  ...
                  //
                  // IMPORTANT:
                  // Previously only the dialog was closing.
                  // Dashboard was remaining visible.
                  //
                  // Now all previous routes are removed and
                  // LoginScreen becomes the first screen.
                  // ==============================================
