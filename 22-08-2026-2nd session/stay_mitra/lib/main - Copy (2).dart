...
class _CreateBillScreenState extends State<CreateBillScreen> {
  ...
  void _selectTenantById(String? tenantId) {
                    ...
                    children: [
                      _formCard(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          items: _tenants
                              .map((tenant) => tenant['id'].toString())
                              .toSet()
                              .map((tenantId) {
                            final tenant = _tenants.firstWhere(
                              (item) => item['id'].toString() == tenantId,
                            );
...
class _UploadRegisterScreenState extends State<UploadRegisterScreen> {
  ...
  Future<void> _pickFile() async {
    try {
      ...
      if (!mounted) return;
      _message('Unable to select the register file.', true);
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                const Align(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    'Choose how you want to add your register.',
                    style: TextStyle(
                      fontSize: 13,
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    'Take a photo of your handwritten register',
                  ),
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    'Select PDF, Excel, CSV, Word or image files',
                  ),
                  trailing: const Icon(Icons.chevron_right_rounded),
                  onTap: () async {
                    Navigator.pop(sheetContext);
  ...
  Future<void> _saveRegister() async {
    if (_selectedFile == null) {
      _message(
        'Please select a register file or take a photo.',
        true,
      );
      return;
    }
                ...
                children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  hasFile
                                      ? _selectedFile!.name
                                      : 'Choose Register File or Take Photo',
                                  maxLines: 2,
                                  overflow: TextOverflow.ellipsis,
                                  style: const TextStyle(
                                    fontSize: 14,
                  ...
                  SizedBox(
                    ...
                    child: FilledButton.icon(
                      ...
                      label: Text(
                        _saving ? 'Uploading...' : 'Upload Register',
                      ),
                    ),
                  ),
                ],
