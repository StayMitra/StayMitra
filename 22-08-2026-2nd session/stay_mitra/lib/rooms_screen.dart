...
Future<void> _loadRooms() async {
  ...
  try {
    ...
    // ==========================================================
    // GET FLOORS FOR ACTIVE PG ONLY
    // ==========================================================

    final floors = await db.getFloors(
      activePg.id,
    );
    ...
    // ==========================================================
    // GET ROOMS FOR ACTIVE PG FLOORS ONLY
    // ==========================================================
      ...
      for (final room in rooms) {
        ...
        for (final bed in beds) {
          ...
          if (bed.status == 'occupied') {
            tenant = await db.getActiveTenantByBed(
              bed.id,
            );
          }
