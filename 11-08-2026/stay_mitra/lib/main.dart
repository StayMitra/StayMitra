...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<void> _loadPropertyStats() async {
    try {
      ...
      // Billing is not implemented as a separate table yet.
      // We therefore calculate the currently outstanding rent from
      // active tenants' monthly rent. This is intentionally a safe
      // interim value until the Billing module records payments
      // against individual tenants/months.
      ...
      setState(() {
        ...
        _pendingRent = amountFrom(rentResult, 'total_rent');
        _pendingRentTenants = countFrom(
          [
            {'count': rentResult.isEmpty ? 0 : rentResult.first['tenant_count']}
          ],
        );
