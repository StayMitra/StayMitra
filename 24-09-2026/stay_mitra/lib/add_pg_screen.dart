...
class _AddPgScreenState extends State<AddPgScreen> {
  ...
  Future<void> _savePg() async {
    ...
    try {
      ...
      // 2. Existing SQLite
      //
      // This keeps both data sources connected to the same PG.
      //
      // ========================================================

      final propertyId = _newId();

      final pgName = _nameController.text.trim();
      ...
      // ========================================================
      // CREATE FIRESTORE PROPERTY
      // ========================================================
      //
      // IMPORTANT:
      // Firebase uses the actual logged-in Firebase UID.
      //
      // We are NOT using widget.ownerId here because the current
      // existing app still uses the old local SQLite owner ID.
      //
      // This allows us to migrate safely without disturbing
      // existing local PG data.
      //
      // ========================================================
      ...
      // ========================================================
      //
      // Firebase is our new cloud/source-of-truth layer.
      //
      // Existing SQLite is still preserved below for
      // compatibility with the current application.
      //
      // ========================================================

      await PropertyService.instance.createProperty(
        property,
      );

      // ========================================================
      // CREATE LOCAL SQLITE PG
      // ========================================================
      //
      // IMPORTANT:
      // Keep the existing local ownerId.
      //
      // This prevents existing SQLite data from being broken
      ...
      // ========================================================
      // SAVE ONLY THIS NEW PG TO SQLITE
      // ========================================================
