...
Future<void> _loadPropertyStats() async {
  try {
    ...
    // ==========================================================
    // CALCULATE PENDING RENT PER TENANT
    // ==========================================================
    ...
    for (final tenant in activeTenants) {
      ...
      final tenantName =
          tenant['full_name']?.toString().trim().toLowerCase() ?? '';
      ...
      final pendingForTenant =
          (monthlyRent - paidThisMonth).clamp(
        0.0,
        double.infinity,
      );
    ...
    builder: (context, child) {
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            LanguageService.instance.get('check_in'),
            style: const TextStyle(
              fontSize: 21,
              fontWeight: FontWeight.bold,
            ),
